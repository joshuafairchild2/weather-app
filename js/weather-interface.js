...
const displayCelsius = (city, celsius) => $("#celsius").text(`It is ${celsius} degrees celsius in ${city}`);
...
$(() => {
  ...
  $("#city-form").submit((e) => {
    ...
    $("#city-input").val('');
    weather.displayWeather(city, displayHumidity, displayKelvin, displayWindSpeed, displayFahrenheit, displayCelsius);
  });
});
